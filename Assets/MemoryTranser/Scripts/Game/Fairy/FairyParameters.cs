...
namespace MemoryTranser.Scripts.Game.Fairy {
    public class FairyParameters {
        ...
        public const float INITIAL_WALK_SPEED = 5f;
        ...
        public float WalkSpeed {
            get => Mathf.Clamp(_walkSpeed, MIN_WALK_SPEED, MAX_WALK_SPEED);
        }

        public float ThrowPower {
            get => Mathf.Clamp(_throwPower, MIN_THROW_POWER, MAX_THROW_POWER);
        }
